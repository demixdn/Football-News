...
public class UseCaseTest {
    ...
    public void setUp() throws Exception {
        this.useCase = new UseCaseTestClass(mockUiScheduler, mockWorkerScheduler);
        this.testObserver = new TestDisposableObserver<>();
        given(mockUiScheduler.getScheduler()).willReturn(new TestScheduler());
        given(mockWorkerScheduler.getScheduler()).willReturn(new TestScheduler());
    }
    ...
    private static class UseCaseTestClass extends UseCase<Object, Params> {
        ...
        UseCaseTestClass(UIScheduler uiScheduler, WorkerScheduler workerScheduler) {
